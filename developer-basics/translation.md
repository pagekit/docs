...
When the Installer is run, the locale is selected manually. This can later be changed in the Pagekit backend (*System / Localization*). You can set a different locale for front-end and back-end.
